...
enum CUR_INS_STATE {
    CUR_INS_STATE_NONE,
    CUR_INS_STATE_EMULATED,
    CUR_INS_STATE_TO_SIE,
    CUR_INS_STATE_TO_NATIVE,
    CUR_INS_STATE_TO_NATIVE_EMU,
};
...
class CThinCtrl {
    ...
    ulong isUsingFSGS(Instruction* in);
   ...
   private:
    bool isFlagChanging(Instruction* in);
