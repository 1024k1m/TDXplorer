 ...
 */
   ...
   public:
    SYMemState(void) : m_Bitmap(), m_AllSymbolList(), khole_access(0), non_khole_access(0) {}
    ~SYMemState(void) { }

    ulong khole_access;
    ulong non_khole_access;
   ...
   private:
    ...
    bool sendSeamMemAccessReq(SERVREQ req, ulong seam_va, long &data, ulong size);
};
